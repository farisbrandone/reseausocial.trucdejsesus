...
function ButtonUploadAudio({
  ...
  const handleFileChange2 = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    const supportedFormats = ["audio/mp3", "audio/wav", "audio/aac"];
    ...
    if (file.size > 1048576) {
      toast({
        variant: "destructive",
        title: "Erreur",
        description: "la taille du fichier est supérieur à 1Mo",
      });
      return;
    }
      ...
      >
        {stateDownloadProps ? (
          ...
          <div className="flex  items-center gap-1 p-0">
            ...
            <p className="flex flex-col text-[16px] text-gray-500 dark:text-gray-400">
              <span className="font-semibold">
                {" "}
                Télécharger ou glisser-déposer un fichier audio{" "}
              </span>{" "}
